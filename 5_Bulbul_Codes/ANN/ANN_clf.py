...
#**************Importing data where all output are normalized by MKM**********************;
test_sizes = [0.3, 0.1]
model        = MLPClassifier(activation='relu', alpha=0.0001, hidden_layer_sizes=200, learning_rate='adaptive',
solver='adam', early_stopping=True, random_state=42, max_iter=5000)
#
for test_size in test_sizes:
    filename    = 'ANN_clf_output_' + str(test_size) + '.txt'
