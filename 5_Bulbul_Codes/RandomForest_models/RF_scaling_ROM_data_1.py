...
joblib.dump(scaler, "RF_standardscaler_1.save")
...
joblib.dump(model_fit, 'RFReg_scale_ROM_A_1.pkl') #1% training data and 99% test data
...
ML_model = model_fit
test_percent = 0.99
filename    = 'RFReg_bootstrp_False_output_1.txt'
