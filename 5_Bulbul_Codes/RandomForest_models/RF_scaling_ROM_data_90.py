...
joblib.dump(scaler, "RF_standardscaler_90.save")
...
joblib.dump(model_fit, 'RFReg_scale_ROM_A_90.pkl') #1% training data and 99% test data
...
ML_model = model_fit
test_percent = 0.1
filename    = 'RFReg_bootstrp_False_output_90.txt'
