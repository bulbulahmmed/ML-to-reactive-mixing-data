...
grid_search = GridSearchCV(model, param_grid=param_grid, cv=5, n_jobs=-1, iid=False)
model_fit   = grid_search.fit(X_train, y_train)
joblib.dump(model_fit, 'RFReg_ROM_A_noscaling.pkl') #1% training data and 99% test data
