...
#
joblib.dump(bagging_model_fit, 'bagging_scale_ROM_A1.pkl') #1% training data and 99% test data
joblib.dump(dec_tree_model_fit, 'Dec_tree_scale_ROM_A1.pkl') #1% training data and 99% test data
...
time_taken = toc - tic
test_percent = 0.99
filename1    = 'bagging_output_1.txt'
filename2    = 'dec_tree_output_1.txt'
