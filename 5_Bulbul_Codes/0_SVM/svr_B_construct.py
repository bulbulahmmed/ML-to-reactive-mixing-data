#**********************************************************************;
#  Species-B: SVR-ROMs construction using various kernels              ;
...
#          (norm_avg_conc_B, norm_avg_sq_conc_B, norm_var_conc_B)      ;
...
#=====================================================================================;
#  Avg.Conc: CONSTRUCT and TEST SVR-ROMs and their performance metrics for species-B  ;
#=====================================================================================;
...
joblib.dump(model_fit, 'svr_B_avg_train_01.pkl') #1% training data and 99% test data
#
...
#========================================================================================;
#  Avg.Sq.Conc: CONSTRUCT and TEST SVR-ROMs and their performance metrics for species-B  ;
#========================================================================================;
...
model = svm.SVR(kernel = 'rbf', C = 1e4, gamma = 0.1, verbose = True)
model_fit = model.fit(X_train, y_train)
joblib.dump(model_fit, 'svr_B_avgsq_train_01.pkl') #1% training data and 99% test data
#
model_score_train = model_fit.score(X_train, y_train)
print 'Training score = ', model_score_train
#
...
#================================================================================;
#  DoM: CONSTRUCT and TEST SVR-ROMs and their performance metrics for species-B  ;
#================================================================================;
...
model = svm.SVR(kernel = 'rbf', C = 1e4, gamma = 0.1, verbose = True)
model_fit = model.fit(X_train, y_train)
joblib.dump(model_fit, 'svr_B_DoM_train_01.pkl') #1% training data and 99% test data
#
model_score_train = model_fit.score(X_train, y_train)
print 'Training score = ', model_score_train
#
