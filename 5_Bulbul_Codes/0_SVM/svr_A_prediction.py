#**********************************************************************;
#  SVR-ROMs (Species-A): Prediction of ROMs and R2-scores              ;
...
#===============================================================;
realiz_id = np.genfromtxt('ROMs_Input_A.txt', skip_header = 1, \
                           delimiter = ',', usecols = (0))
realiz_id = np.unique(realiz_id).astype(int)
num_realizations, = realiz_id.shape
#
ROM_data      = np.genfromtxt('ROMs_Input_A.txt', skip_header = 1, \
...
#*************************************************************;
#  Plot-1: Species-A: Data vs prediction (Avg. sq. of. conc)  ;
#*************************************************************;
...
str_plot_title = 'Species-A: Avg. of Conc.'
str_fig_name   = 'A_avg_predict'
#
model_fit = joblib.load('svr_A_avg_train_01.pkl') #1% training data and 99% test data 
print 'SVR-Model-A = ', model_fit
#
...
#*************************************************************;
#  Plot-2: Species-A: Data vs prediction (Avg. Sq. of. Conc)  ;
#*************************************************************;
ids_list       = [17, 315, 947, 1595, 1870, 2219] #Goes from 0 to 2315, ids_list = range(0, num_realizations)
#ids_list      = [1870]
str_label_x    = 'Time'
str_label_y    = 'Avg. Sq. of Conc.'
str_plot_title = 'Species-A: Avg. Sq. of Conc.'
str_fig_name   = 'A_avgsq_predict'
#
model_fit = joblib.load('svr_A_avgsq_train_01.pkl') #1% training data and 99% test data 
print 'SVR-Model-A = ', model_fit
#
plot_SVR_vs_data(ids_list, str_label_x, str_label_y, str_plot_title, \
...
#************************************************************;
#  Plot-3: Species-A: Data vs prediction (Degree of Mixing)  ;
#************************************************************;
ids_list       = [17, 315, 947, 1595, 1870, 2219] #Goes from 0 to 2315, ids_list = range(0, num_realizations)
#ids_list      = [1870]
str_label_x    = 'Time'
str_label_y    = 'Degree of mixing'
str_plot_title = 'Species-A: Degree of mixing'
str_fig_name   = 'A_DoM_predict'
#
model_fit = joblib.load('svr_A_DoM_train_01.pkl') #1% training data and 99% test data 
print 'SVR-Model-A = ', model_fit
#
plot_SVR_vs_data(ids_list, str_label_x, str_label_y, str_plot_title, \
