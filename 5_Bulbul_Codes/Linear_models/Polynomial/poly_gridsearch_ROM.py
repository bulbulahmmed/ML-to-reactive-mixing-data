...
# Preprocessing
features = [2, 3, 4, 5, 6]
''' 3 took way longer than 2 and showed memory error'''
for feat in features:
    scaler    = PolynomialFeatures(feat).fit(X_train)  # This is creating an object for scaling. Also, this can be utilized on test data
...
filename    = 'polynomial_grid_search.txt'
