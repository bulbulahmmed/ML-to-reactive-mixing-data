...
model       = SGDRegressor(loss='squared_loss', penalty='l2', max_iter=100, shuffle=True, random_state=42, early_stopping=True)
#model       = SGDClassifier(loss='squared_loss', penalty='l2', max_iter=100, shuffle=True, random_state=42, early_stopping=True)
#
for test_size in test_sizes:
    #filename    = 'SGD_clf_output_' + str(test_size) + '.txt'
    filename    = 'SGD_Reg_output_' + str(test_size) + '.txt'
