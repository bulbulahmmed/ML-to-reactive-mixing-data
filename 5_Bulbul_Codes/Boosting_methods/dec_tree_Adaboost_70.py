...
joblib.dump(dec_tree_Adaboost_model_fit, pkl2) #1% training data and 99% test data
...
writing_output(filename2, test_percent, dec_tree_Adaboost_training_score, dec_tree_Adaboost_testing_score, time_taken, dec_tree_Adaboost_model)
