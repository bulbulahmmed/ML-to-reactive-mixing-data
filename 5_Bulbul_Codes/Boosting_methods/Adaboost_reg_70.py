...
joblib.dump(Adaboost_model_fit, pkl2) #1% training data and 99% test data
...
writing_output(filename2, test_percent, Adaboost_training_score, Adaboost_testing_score, time_taken, Adaboost_model)
