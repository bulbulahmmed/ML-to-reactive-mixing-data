...
test_size = 0.1, random_state = 42) #Avg. Conc
...
# Creating models
Adaboost_model    = AdaBoostRegressor(n_estimators=100, learning_rate=1, loss= 'square', random_state=42)
...
#Adaboost_grid_search = GridSearchCV(Adaboost_model, param_grid=Adaboost_param_grid, cv=5, n_jobs=32, iid=False)
#Adaboost_model_fit   = Adaboost_grid_search.fit(X_train, y_train)
#
pkl1 = 'Adaboost_scale_ROM_A1.pkl'
pkl2 = 'Adaboost_scale_ROM_A70.pkl'
pkl3 = 'Adaboost_scale_ROM_A90.pkl'
joblib.dump(Adaboost_model_fit, pkl3) #1% training data and 99% test data
...
#
Adaboost_training_score  = Adaboost_model_fit.score(X_train, y_train)
Adaboost_testing_score   = Adaboost_model_fit.score(X_test, y_test)
#==================================================================================;
...
time_taken = toc - tic
test_percent = 0.1
filename1    = 'Adaboost_output_1.txt'
filename2    = 'Adaboost_output_70.txt'
filename3    = 'Adaboost_output_90.txt'
'''Running the function '''
writing_output(filename3, test_percent, Adaboost_training_score, Adaboost_testing_score, time_taken, Adaboost_model)
